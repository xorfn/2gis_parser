...
class SqliteDb:
    ...
    def create_data_urls(self, data, config_table_urls):
        ...
        create_table = f"""CREATE TABLE {table} (PK INTEGER NOT NULL, urls TEXT, {column[0]} TEXT, {column[1]} TEXT, {column[2]} TEXT, PRIMARY KEY (PK))"""
        ...
        for url in data_urls:
            write_data = f"""insert into {table} (urls) values (?)"""
